...
public class ContainerPortTable extends Container
{
    ...
    public ContainerPortTable(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
