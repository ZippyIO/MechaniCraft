...
public class ContainerHighSpeedFurnace extends Container
{
    private TileEntityHighSpeedFurnace highSpeed;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerHighSpeedFurnace(InventoryPlayer par1InventoryPlayer, TileEntityHighSpeedFurnace par2TileEntityHighSpeedFurnace)
    {
        this.highSpeed = par2TileEntityHighSpeedFurnace;
        this.addSlotToContainer(new Slot(par2TileEntityHighSpeedFurnace, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityHighSpeedFurnace, 1, 56, 53));
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityHighSpeedFurnace, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (TileEntityHighSpeedFurnace.isItemFuel(var5))
                {
