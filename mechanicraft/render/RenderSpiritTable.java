...
{
	private static final ResourceLocation book = new ResourceLocation("mechanicraft", "textures/gui/book.png");
    ...
    public void renderTileEntitySpiritTableAt(TileEntitySpiritTable par1TileEntitySpiritTable, double par2, double par4, double par6, float par8)
    {
        ...
        //this.bindTextureByName("/mods/BetterCraft/textures/gui/book.png");
