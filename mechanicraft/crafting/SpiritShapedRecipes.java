...
public class SpiritShapedRecipes implements IRecipe
{
    ...
    public SpiritShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public SpiritShapedRecipes func_92100_c()
    {
