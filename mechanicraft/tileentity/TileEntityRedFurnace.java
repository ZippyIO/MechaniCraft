...
public class TileEntityRedFurnace extends TileEntity implements IInventory, ISidedInventory
{
    ...
    public boolean isRedPowered()
    {
        ...
        return world.getBlockId(xCoord, yCoord - 1, zCoord) == Block.redstoneLampActive.blockID || world.getBlockId(xCoord, yCoord - 1, zCoord) == Block.torchRedstoneActive.blockID;
    }
    ...
    public void updateEntity()
    {
        ...
        {
            furnaceBurnTime = 0;
            BlockRedFurnace.updateFurnaceBlockState(false, worldObj, xCoord, yCoord, zCoord);
        }
        ...
        {
            furnaceCookTime++;
            BlockRedFurnace.updateFurnaceBlockState(true, worldObj, xCoord, yCoord, zCoord);
