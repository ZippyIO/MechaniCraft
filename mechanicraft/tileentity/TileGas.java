...
import mechanicraft.blocks.BlockGasGeneric;
import mechanicraft.lib.Tuple;
import mechanicraft.lib.Util;
...
public class TileGas extends TileEntity 
{
	...
	public static final int VOLUME = FluidContainerRegistry.BUCKET_VOLUME / 2;
	Random rand;
	int count;
