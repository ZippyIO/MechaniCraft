...
public class TileEntityHighSpeedFurnace extends TileEntity implements IInventory, ISidedInventory
{
    ...
    {
        return this.furnaceCookTime * par1 / 50;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockHighSpeedFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (var1 == Item.stick.itemID) return 25;
            if (var1 == Item.coal.itemID) return 100;
            if (var1 == Item.bucketLava.itemID) return 5000;
            if (var1 == Block.sapling.blockID) return 25;
            if (var1 == Item.blazeRod.itemID) return 600;
