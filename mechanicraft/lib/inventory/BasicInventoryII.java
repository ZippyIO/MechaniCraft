...
import mechanicraft.lib.INBTTagable;
 ...
 * @author Xhamolk_
 */
public class BasicInventoryII implements IInventory, INBTTagable {
	 ...
	 */
	public BasicInventoryII(int size, String name) {
		this.size = size;
		this.name = name;
	...
	public ItemStack getContentsII(int i) {
		return this.internalInv[i];
	}
	
	public ItemStack setContentsII(int i, ItemStack item) {
		return this.internalInv[i] = item;
	}
	...
	public boolean addStack(ItemStack stack) {
		...
		ItemStack remaining = InventoryUtilities.addStackToInventory( stack, this, true );
		if( remaining == null ) {
			stack.stackSize = 0;
			return true;
		}
		...
		remaining = InventoryUtilities.addStackToInventory( remaining, this, false );
		if( remaining == null ) {
			stack.stackSize = 0;
			return true;
		}
